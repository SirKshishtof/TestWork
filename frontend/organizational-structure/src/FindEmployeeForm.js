...
import { bigButtonStyle, labelStyle, littleButtonStyle } from "./styles.js";
import {
  TextField,
  Box,
  Button,
    ...
    if (employeeStr != null && employeeStr != "") {
      if (allOptions.length == 0) {
        ...
        if (selectedOption != "" && selectedOption != null) {
          ...
          await fireEmplloye(employeeCode, selectedOption.slice(0, selectedOption.indexOf(" ", 0)));
          alert("Сотрудник уволен");
        } else {
  ...
  return (
    <div>
      ...
      >
        ...
        <Button style={bigButtonStyle} onClick={handleClick_FindEmployee}>
          Найти сотрудника
        </Button>

        <label style={labelStyle}>Найденный сотрудник: {employeeStr}</label>
        ...
        <div>
          <Button style={littleButtonStyle} onClick={handleClick_FireEmployee}>
            Уволить сотрудника
          </Button>
